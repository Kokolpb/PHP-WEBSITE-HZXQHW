...
<div id="caselist">
  <a href="caseinfo.php?cid=<?php echo $case_ny[$i][id_newsinfo]?>"><img src="/upload/news/<?php echo $case_ny[$i][opicname];?>" width="160" height="150" /></a>
  <h1><a href="caseinfo.php?cid=<?php echo $case_ny[$i][id_newsinfo]?>"><?php echo $case_ny[$i][title];?></a></h1>
</div><!--end caselist!-->
<?php }?>
