...
if(!isset($_GET[sdir]) || $_GET[sdir]==''){
$strSQL = "select title,content from pageset where id_pageset='6'" ;
$objDB->Execute($strSQL);
$service=$objDB->fields();

}elseif(isset($_GET[sdir])){

$strSQL = "select title,content from pageset where id_pageset='".$_GET[sdir]."'" ;
$objDB->Execute($strSQL);
$service=$objDB->fields();
}
...
<div id="content_aboutrighttitle1"><?=$service[title];?></div>
<div id="about_navi">您现在的位置：<A href="/">杭州鑫桥会展</A> &gt; <?=$service[title];?></div>
