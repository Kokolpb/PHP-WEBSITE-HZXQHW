...
//项目案例
$strSQL = "select title,content from newsinfo where id_newsinfo=$_GET[nid]" ;
$objDB->Execute($strSQL);
$hotelinfo_ny=$objDB->fields();
...
<div id="case_title"><?php echo $hotelinfo_ny[title];?></div>
<div id="case_content"><?php echo $hotelinfo_ny[content];?></div>
