...
$strSQL = "select title,content from newsinfo where id_newsinfo=$_GET[gid]" ;
$objDB->Execute($strSQL);
$giftinfo_ny=$objDB->fields();
...
<div id="case_title"><?php echo $giftinfo_ny[title];?></div>
<div id="case_content"><?php echo $giftinfo_ny[content];?></div>
