...
//contact
$strSQL = "select content from pageset where id_pageset='12'" ;
...
<div id="content_aboutrighttitle1">人才招聘</div>
<div id="about_navi">您现在的位置：<A href="/">杭州鑫桥会展</A> &gt; 人才招聘</div>

</div><!--end content_aboutrighttitle!-->

<div id="content_aboutrightcont">
  <div id="pagecontent"><?=$contact[content];?></div>
