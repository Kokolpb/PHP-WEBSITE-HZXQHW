...
//项目案例
$strSQL = "select title,content from newsinfo where id_newsinfo=$_GET[cid]" ;
$objDB->Execute($strSQL);
$caseinfo_ny=$objDB->fields();
...
<div id="case_title"><?php echo $caseinfo_ny[title];?></div>
<div id="case_content"><?php echo $caseinfo_ny[content];?></div>
