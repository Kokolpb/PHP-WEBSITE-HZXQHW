...
//企业文化
$strSQL = "select content from pageset where id_pageset='3'" ;
$objDB->Execute($strSQL);
$history=$objDB->fields();
...
<div id="content_aboutrighttitle1">发展历程</div>
<div id="about_navi">您现在的位置：<A href="/">杭州鑫桥会展</A> &gt; 发展历程</div>
